...
function initialize1101panel()
	...
	make /t /o /n=5000 basenames,motors,scans,scantypes,times,files, motor1pos,motor2pos,motor3pos,motor4pos,motor5pos,darkpos,I0s
...
Function LoadAndGenerateStringAll(path)
	...
	String graphName
	Variable index=0
	make /t /o /n=500 basenames,motors,scans,scantypes,times,motor1pos, motor2pos,motor3pos, motor4pos,motor5pos, darkpos, I0s
	scans=""
	...
	Variable result
	motor1pos=""; motor2pos="";motor3pos="";motor4pos="";motor5pos="";darkpos=""; I0s=""
	...
	redimension /n=(goodindex,-1) motor1pos, motor2pos,motor3pos, motor4pos,motor5pos, darkpos, I0s
	sort scanNum, scans, FSindex, basenames, times, scantypes, motors, nmotors,frames, motor1pos, motor2pos,motor3pos, motor4pos,motor5pos, darkpos, I0s
	SetDataFolder $CurrentFolder
...
Function LoadandStoreData(Filename,path,index)
	...
	wave /t basenames,motors,scans,scantypes,times,motor1pos,motor2pos,motor3pos,motor4pos,motor5pos,darkpos,I0s
...
function loaddatalist(row)
	...
	string/g filelist
	svar ccdpath
	wave/t basenames,motors,motor1pos,motor2pos,motor3pos,motor4pos,motor5pos, darkpos
	wave nmotors
