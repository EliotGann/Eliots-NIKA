...
// and displays a list of datapoints with their primary motors defining the name
	...
	string jsonfiles= indexedfile($(pnameimages),-1,".jsonl")
	string jsonext = ".jsonl"
	if(strlen(jsonfiles)==0)
		jsonfiles= indexedfile($(pnameimages),-1,".json")
		jsonext = ".json"
	endif
	...
	if(strlen(jsonfiles) < 5)
		...
		jsonfound = 1
		metadatafilename = stringfromlist(0,jsonfiles)
	endif
	if(jsonfound)
		metadatafilename = stringfromlist(0,greplist(jsonfiles,"^"+basename))
		metadata = addmetadatafromjson(pnameimages,"scan_id",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"institution",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"project_name",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"proposal_id",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"sample_name",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"sample_desc",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"sample_id",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"sample_set",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"user_name",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"user_id",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"notes",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"uid",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"dim1",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"dim2",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"dim3",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"chemical_formula",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"density",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"project_desc",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"RSoXS_config",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"RSoXS_Main_DET",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"RSoXS_WAXS_SDD",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"RSoXS_WAXS_BCX",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"RSoXS_WAXS_BCY",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"RSoXS_SAXS_SDD",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"RSoXS_SAXS_BCX",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"RSoXS_SAXS_BCY",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"plan_name",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"master_plan",metadatafilename,metadata)
		metadata = addmetadatafromjson(pnameimages,"plan_history",metadatafilename,metadata)
