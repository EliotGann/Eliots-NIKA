...
Menu "RSoXS"
		...
		submenu "RSoXS Simulations"
			"Igor Simulation System", /Q, Execute/P "INSERTINCLUDE \"3DSimulationsv5\"";Execute/P "COMPILEPROCEDURES ";Execute/P/Q "Model3Dpanel()"
			"Analyze CY-RSoXS Data", /Q, Execute/P "INSERTINCLUDE \"3DSimulationsv5\"";Execute/P "COMPILEPROCEDURES ";Execute/P/Q "load_CV_HDF5_into_wave()"
		end
End
